...
all_cert_lp_info.to_csv('../processed_data/portfolio_cert_lp_info.csv',mode='a')
...
all_cert_module_info.to_csv('../processed_data/portfolio_cert_module_info.csv',mode='a')
